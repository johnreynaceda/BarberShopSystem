...
class BarberList extends Component implements HasForms, HasTable
{
    ...
    {
        return $table
            ->query(Barber::query()->where('shop_id', auth()->user()->shop_id))->headerActions([
    ...
    {
        return view('livewire.manager.barber-list');
    }
}
