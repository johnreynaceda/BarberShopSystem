    ...
    <div class=" mt-5 ">
        ...
        <ul class="flex">
            <template x-for="star in max_stars">
                <li @mouseover="hoverStar(star)" @mouseleave="mouseLeftStar" @click="rate(star)" class="px-1 cursor-pointer"
                    :class="{ 'text-gray-400 cursor-not-allowed': disabled }">
                    <svg x-show="star > stars" class="w-6 h-6 text-gray-900" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 256 256">
                    ...
                    <svg x-show="star <= stars" class="w-6 h-6 text-gray-900 fill-current"
        ...
        <button @click="reset"
            class="inline-flex items-center px-2 py-1 mt-3 text-xs text-white bg-gray-900 rounded-full hover:bg-black hover:text-white">
